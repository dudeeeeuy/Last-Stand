...
class Player:
    ...
    def set_max_health(self, time):
        self.max_health = time

    def set_health(self, time):
        self.health = time
...
class Bullet:
    ...
    def __init__(self, gdata, pos, ang, rad=10, dmg=50, vel=1):
        self.gdata = gdata
